...
#ifndef STM_USART_DEBUG
#define STM_USART_DEBUG 0
#endif

#define DB_PRINT_L(lvl, fmt, args...) do { \
    if (STM_USART_DEBUG >= lvl) { \
...
static const VMStateDescription vmstate_stm32f1xx_usart = {
    .name = TYPE_STM32F1XX_USART,
    .version_id = 1,
    .minimum_version_id = 1,
    .fields = (VMStateField[]) {
        VMSTATE_UINT32(usart_sr, STM32F1XXUsartState),
        VMSTATE_UINT32(usart_dr, STM32F1XXUsartState),
        VMSTATE_UINT32(usart_brr, STM32F1XXUsartState),
        VMSTATE_UINT32(usart_cr1, STM32F1XXUsartState),
        VMSTATE_UINT32(usart_cr2, STM32F1XXUsartState),
        VMSTATE_UINT32(usart_cr3, STM32F1XXUsartState),
        VMSTATE_UINT32(usart_gtpr, STM32F1XXUsartState),
        VMSTATE_END_OF_LIST()
    }
};
...
static void stm32f1xx_usart_class_init(ObjectClass *klass, void *data)
{
    ...
    dc->vmsd    = &vmstate_stm32f1xx_usart;
}

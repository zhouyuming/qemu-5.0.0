...
static const VMStateDescription vmstate_stm32f4xx_usart = {
    .name = TYPE_STM32F4XX_USART,
    .version_id = 1,
    .minimum_version_id = 1,
    .fields = (VMStateField[]) {
        VMSTATE_UINT32(usart_sr, STM32F4XXUsartState),
        VMSTATE_UINT32(usart_dr, STM32F4XXUsartState),
        VMSTATE_UINT32(usart_brr, STM32F4XXUsartState),
        VMSTATE_UINT32(usart_cr1, STM32F4XXUsartState),
        VMSTATE_UINT32(usart_cr2, STM32F4XXUsartState),
        VMSTATE_UINT32(usart_cr3, STM32F4XXUsartState),
        VMSTATE_UINT32(usart_gtpr, STM32F4XXUsartState),
        VMSTATE_END_OF_LIST()
    }
};

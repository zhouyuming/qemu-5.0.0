...
static bool disas_t16(DisasContext *ctx, uint16_t insn)
{
    ...
    case 0x0:
        ...
        case 0x0:
            /* 00000... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:137 */
            u.f_s_rrr_shi.shty = 0;
            if (trans_MOV_rxri(ctx, &u.f_s_rrr_shi)) return true;
            return false;
        case 0x1:
            /* 00001... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:138 */
    ...
    case 0x1:
        ...
        case 0x0:
            /* 00010... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:139 */
            disas_t16_extract_shift_i(ctx, &u.f_s_rrr_shi, insn);
    ...
    case 0x2:
        ...
        case 0x0:
            /* 00100... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:163 */
            u.f_s_rri_rot.s = t16_setflags(ctx);
            if (trans_MOV_rxi(ctx, &u.f_s_rri_rot)) return true;
            return false;
        case 0x1:
            /* 00101... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:164 */
            u.f_s_rri_rot.s = 1;
    ...
    case 0x3:
        ...
        case 0x0:
            /* 00110... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:165 */
            u.f_s_rri_rot.s = t16_setflags(ctx);
            if (trans_ADD_rri(ctx, &u.f_s_rri_rot)) return true;
            return false;
        case 0x1:
            /* 00111... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:166 */
            u.f_s_rri_rot.s = t16_setflags(ctx);
            if (trans_SUB_rri(ctx, &u.f_s_rri_rot)) return true;
            return false;
        }
    ...
    case 0x4:
        ...
        case 0x0:
            ...
            case 0x0:
                ...
                case 0x0:
                    /* 01000000 00...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:53 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
                    if (trans_AND_rrri(ctx, &u.f_s_rrr_shi)) return true;
                    return false;
                case 0x1:
                    /* 01000000 01...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:54 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
                    if (trans_EOR_rrri(ctx, &u.f_s_rrr_shi)) return true;
                    return false;
                case 0x2:
                    /* 01000000 10...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:55 */
                ...
                case 0x3:
                    /* 01000000 11...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:56 */
                    disas_t16_extract_lxl_shr(ctx, &u.f_s_rrr_shr, insn);
            ...
            case 0x1:
                ...
                case 0x0:
                    /* 01000001 00...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:57 */
                    disas_t16_extract_lxl_shr(ctx, &u.f_s_rrr_shr, insn);
                ...
                case 0x1:
                    /* 01000001 01...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:58 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
                    if (trans_ADC_rrri(ctx, &u.f_s_rrr_shi)) return true;
                    return false;
                case 0x2:
                    /* 01000001 10...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:59 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
                    if (trans_SBC_rrri(ctx, &u.f_s_rrr_shi)) return true;
                    return false;
                case 0x3:
                    /* 01000001 11...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:60 */
                    disas_t16_extract_lxl_shr(ctx, &u.f_s_rrr_shr, insn);
            ...
            case 0x3:
                ...
                case 0x0:
                    /* 01000011 00...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:65 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
                    if (trans_ORR_rrri(ctx, &u.f_s_rrr_shi)) return true;
                    return false;
                case 0x1:
                    /* 01000011 01...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:66 */
                    disas_t16_extract_disas_t16_Fmt_4(ctx, &u.f_s_rrrr, insn);
                    if (trans_MUL(ctx, &u.f_s_rrrr)) return true;
                    return false;
                case 0x2:
                    /* 01000011 10...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:67 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
                    if (trans_BIC_rrri(ctx, &u.f_s_rrr_shi)) return true;
                    return false;
                case 0x3:
                    /* 01000011 11...... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:68 */
                    disas_t16_extract_lll_noshr(ctx, &u.f_s_rrr_shi, insn);
            ...
            case 0x4:
                /* 01000100 ........ */
                /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:174 */
            ...
            case 0x5:
                /* 01000101 ........ */
                /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:175 */
                disas_t16_extract_addsub_2h(ctx, &u.f_s_rrr_shi, insn);
                u.f_s_rrr_shi.s = 1;
                if (trans_CMP_xrri(ctx, &u.f_s_rrr_shi)) return true;
                return false;
            case 0x6:
                /* 01000110 ........ */
                /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:176 */
                disas_t16_extract_addsub_2h(ctx, &u.f_s_rrr_shi, insn);
                u.f_s_rrr_shi.s = 0;
                if (trans_MOV_rxri(ctx, &u.f_s_rrr_shi)) return true;
                return false;
            case 0x7:
                ...
                case 0x00000000:
                    /* 01000111 0....000 */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:191 */
                    if (trans_BX(ctx, &u.f_r)) return true;
                    return false;
                case 0x00000004:
                    /* 01000111 0....100 */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:193 */
                    if (trans_BXNS(ctx, &u.f_r)) return true;
                    return false;
                case 0x00000080:
                    /* 01000111 1....000 */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:192 */
                    if (trans_BLX_r(ctx, &u.f_r)) return true;
                    return false;
                case 0x00000084:
                    /* 01000111 1....100 */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:194 */
        ...
        case 0x1:
            /* 01001... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:118 */
    ...
    case 0x5:
        ...
        case 0x0:
            /* 0101000. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:75 */
            if (trans_STR_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x1:
            /* 0101001. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:76 */
            if (trans_STRH_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x2:
            /* 0101010. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:77 */
            if (trans_STRB_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x3:
            /* 0101011. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:78 */
            if (trans_LDRSB_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x4:
            /* 0101100. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:79 */
            if (trans_LDR_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x5:
            /* 0101101. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:80 */
            if (trans_LDRH_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x6:
            /* 0101110. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:81 */
            if (trans_LDRB_rr(ctx, &u.f_ldst_rr)) return true;
            return false;
        case 0x7:
            /* 0101111. ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:82 */
    ...
    case 0x6:
        ...
        case 0x0:
            /* 01100... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:93 */
            if (trans_STR_ri(ctx, &u.f_ldst_ri)) return true;
            return false;
        case 0x1:
            /* 01101... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:94 */
            if (trans_LDR_ri(ctx, &u.f_ldst_ri)) return true;
            return false;
        }
        return false;
    case 0x7:
        ...
        case 0x0:
            /* 01110... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:95 */
            if (trans_STRB_ri(ctx, &u.f_ldst_ri)) return true;
            return false;
        case 0x1:
            /* 01111... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:96 */
    ...
    case 0x8:
        ...
        case 0x0:
            /* 10000... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:104 */
            if (trans_STRH_ri(ctx, &u.f_ldst_ri)) return true;
            return false;
        case 0x1:
            /* 10001... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:105 */
    ...
    case 0x9:
        ...
        case 0x0:
            /* 10010... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:113 */
            u.f_ldst_ri.rn = 13;
            if (trans_STR_ri(ctx, &u.f_ldst_ri)) return true;
            return false;
        case 0x1:
            /* 10011... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:114 */
            u.f_ldst_ri.rn = 13;
            if (trans_LDR_ri(ctx, &u.f_ldst_ri)) return true;
            return false;
        }
    ...
    case 0xa:
        ...
        case 0x0:
            /* 10100... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:122 */
            disas_t16_extract_disas_t16_Fmt_10(ctx, &u.f_ri, insn);
            if (trans_ADR(ctx, &u.f_ri)) return true;
            return false;
        case 0x1:
            /* 10101... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:123 */
    ...
    case 0xb:
        ...
        case 0x0:
            ...
            case 0x0:
                ...
                case 0x00000000:
                    /* 10110000 0....... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:184 */
                    disas_t16_extract_addsub_sp_i(ctx, &u.f_s_rri_rot, insn);
                    if (trans_ADD_rri(ctx, &u.f_s_rri_rot)) return true;
                    return false;
                case 0x00000080:
                    /* 10110000 1....... */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:185 */
                    disas_t16_extract_addsub_sp_i(ctx, &u.f_s_rri_rot, insn);
                    if (trans_SUB_rri(ctx, &u.f_s_rri_rot)) return true;
                    return false;
                case 0x00000200:
                    ...
                    case 0x0:
                        /* 10110010 00...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:200 */
                        if (trans_SXTAH(ctx, &u.f_rrr_rot)) return true;
                        return false;
                    case 0x1:
                        /* 10110010 01...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:201 */
                ...
                case 0x00000280:
                    ...
                    case 0x0:
                        /* 10110010 10...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:202 */
                        if (trans_UXTAH(ctx, &u.f_rrr_rot)) return true;
                        return false;
                    case 0x1:
                        /* 10110010 11...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:203 */
                ...
                case 0x00000a00:
                    ...
                    case 0x0:
                        /* 10111010 00...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:219 */
                        if (trans_REV(ctx, &u.f_rr)) return true;
                        return false;
                    case 0x1:
                        /* 10111010 01...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:220 */
                ...
                case 0x00000a80:
                    ...
                    case 0x0:
                        /* 10111010 10...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:246 */
                        disas_t16_extract_disas_t16_Fmt_27(ctx, &u.f_i, insn);
                        if (trans_HLT(ctx, &u.f_i)) return true;
                        return false;
                    case 0x1:
                        /* 10111010 11...... */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:221 */
                        disas_t16_extract_rdm(ctx, &u.f_rr, insn);
            ...
            case 0x1:
                /* 1011.0.1 ........ */
                /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:248 */
        ...
        case 0x1:
            ...
            case 0x00000000:
                /* 1011010. ........ */
                /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:255 */
            ...
            case 0x00000200:
                ...
                case 0x2:
                    ...
                    case 0x00000010:
                        /* 10110110 0101.000 */
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:209 */
            ...
            case 0x00000800:
                /* 1011110. ........ */
                /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:257 */
            ...
            case 0x00000a00:
                ...
                case 0x0:
                    /* 10111110 ........ */
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:247 */
                ...
                case 0x1:
                    ...
                    if ((insn & 0x0000000f) == 0x00000000) {
                        ...
                        if ((insn & 0x000000f0) == 0x00000010) {
                            /* 10111111 00010000 */
                            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:227 */
                        ...
                        if ((insn & 0x000000f0) == 0x00000020) {
                            /* 10111111 00100000 */
                            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:228 */
                            disas_t16_extract_disas_t16_Fmt_25(ctx, &u.f_empty, insn);
                            if (trans_WFE(ctx, &u.f_empty)) return true;
                        }
                        if ((insn & 0x000000f0) == 0x00000030) {
                            /* 10111111 00110000 */
                            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:229 */
                            disas_t16_extract_disas_t16_Fmt_25(ctx, &u.f_empty, insn);
                            if (trans_WFI(ctx, &u.f_empty)) return true;
                        }
                        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:237 */
                        disas_t16_extract_disas_t16_Fmt_25(ctx, &u.f_empty, insn);
                        if (trans_NOP(ctx, &u.f_empty)) return true;
                    }
                    /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:239 */
    ...
    case 0xc:
        ...
        case 0x0:
            /* 11000... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:130 */
            if (trans_STM(ctx, &u.f_ldst_block)) return true;
            return false;
        case 0x1:
            /* 11001... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:131 */
            if (trans_LDM_t16(ctx, &u.f_ldst_block)) return true;
            return false;
        }
        return false;
    case 0xd:
        ...
        if ((insn & 0x00000f00) == 0x00000e00) {
            /* 11011110 ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:265 */
            disas_t16_extract_disas_t16_Fmt_25(ctx, &u.f_empty, insn);
            if (trans_UDF(ctx, &u.f_empty)) return true;
        }
        if ((insn & 0x00000f00) == 0x00000f00) {
            /* 11011111 ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:266 */
            disas_t16_extract_disas_t16_Fmt_28(ctx, &u.f_i, insn);
            if (trans_SVC(ctx, &u.f_i)) return true;
        }
        /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:267 */
    ...
    case 0xe:
        ...
        case 0x0:
            /* 11100... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:274 */
            disas_t16_extract_disas_t16_Fmt_33(ctx, &u.f_i, insn);
            if (trans_B(ctx, &u.f_i)) return true;
            return false;
        case 0x1:
            /* 11101... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:279 */
    ...
    case 0xf:
        ...
        case 0x0:
            /* 11110... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:280 */
            disas_t16_extract_disas_t16_Fmt_35(ctx, &u.f_i, insn);
            if (trans_BL_BLX_prefix(ctx, &u.f_i)) return true;
            return false;
        case 0x1:
            /* 11111... ........ */
            /* /usr1/qemu/qemustm32/qemu-5.0.0/target/arm/t16.decode:281 */
            disas_t16_extract_disas_t16_Fmt_34(ctx, &u.f_i, insn);
